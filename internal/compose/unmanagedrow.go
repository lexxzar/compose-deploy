...
// UnmanagedProjectName is the name of the synthetic project row that stands for
// the host containers carrying no compose project label. The parentheses mark
// it as not a real project name.
...
// zero: the grouped host view must still show the compose projects that did
// load.
//
...
func WithUnmanagedRow(ctx context.Context, hc *HostContainers, projects []Project) []Project {
	...
	return append(projects, Project{Name: UnmanagedProjectName, Unmanaged: true})
}
